...
<div className='flex flex-col items-start gap-8 lg:flex-row'>
 ...
 <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
  ...
  <form action="" className='flex flex-col gap-y-4'>
    ...
    <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm ' type="text" placeholder='Phone Number '  />
    ...
    <div className='flex gap-x-2'><button className='bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition'>Send message</button>
